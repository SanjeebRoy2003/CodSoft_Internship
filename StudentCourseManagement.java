...
public class StudentCourseManagement {
    ...
    public void displayCourses() {
        ...
        for (Course course : courses) {
            ...
            System.out.println("Student Capacity: " + course.getCapacity());
    ...
    public void registerStudent() {
        ...
        students newStudent = new students(id, name);
    ...
    public void startSystem() {
        ...
        do {
            ...
            System.out.println("5. Display Student's Courses");
            ...
            switch (choice) {
                ...
                case 5 -> displayStudentCourses();
                case 4 -> registerStudentForCourse();
    ...
    public static void main(String[] args) {
        StudentCourseManagement system = new StudentCourseManagement();
        system.startSystem();
    }
}
